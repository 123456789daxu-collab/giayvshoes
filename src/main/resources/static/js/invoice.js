...
function renderTable() {
    ...
    pageData.forEach((invoice, index) => {
        ...
        let statusBadge = '';
        if (invoice.trangThai === 1) statusBadge = '<span class="badge badge-success">Hoàn thành</span>';
        else if (invoice.trangThai === 0) statusBadge = '<span class="badge badge-danger">Hủy</span>';
        else statusBadge = '<span class="badge badge-warning">Sắp diễn ra</span>';
