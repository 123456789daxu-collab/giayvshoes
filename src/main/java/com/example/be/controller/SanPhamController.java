...
public class SanPhamController {
    ...
    public String index(Model model, 
        ...
        // Handle sorting if provided from the new template
        ...
        Pageable pageable = PageRequest.of(page > 0 ? page - 1 : 0, size, sortObj); // Spring Data is 0-indexed, UI is 1-indexed for page
